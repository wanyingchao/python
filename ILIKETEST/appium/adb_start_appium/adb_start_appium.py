...
class adb_start_appium(object):
    def __init__(self):
        with open('E://python/ILIKETEST/appium/adb_start_appium/config/desired_caps.yaml') as file:
    ...
    def appium_start(self):
        ...
        subprocess.Popen(cmd, shell=True, stdout=open('E://python/ILIKETEST/appium/adb_start_appium/appium_log/'+str(self.data['port']) + '.log', 'a'), stderr=subprocess.STDOUT)
